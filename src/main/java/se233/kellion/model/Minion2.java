// se233/kellion/model/MinionM2.java
...
public class Minion2 extends Minion {
    ...
    private final double detectRange   = MinionKind.M2.cfg.detectRange;
    private final long   fireIntervalNs = MinionKind.M2.cfg.fireIntervalNs;

    public Minion2(double x, double y, double patrolL, double patrolR) {
        super(x, y, patrolL, patrolR, MinionKind.M2.skin(), MinionKind.M2.cfg,MinionKind.M2);
        this.x = x;
        this.y = y;
        ...
        v.setFitHeight(MinionKind.M2.skin().fitHeight());
        v.setTranslateX(x);
        v.setTranslateY(y);
        v.setScaleX(1);
    }
    public Minion2(double x, double y, double patrolL, double patrolR, MinionKind kind) {
